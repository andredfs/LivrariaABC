...
CREATE TABLE `bairro` (
  ...
  `Nome_Bairro` varchar(400) DEFAULT NULL,
  `Cod_Cidade` int DEFAULT NULL,
  PRIMARY KEY (`Cod_Bairro`),
  KEY `fk_Bairro_Cidade` (`Cod_Cidade`),
...
INSERT INTO `bairro` VALUES (1,'Lago Sul',1),(2,'Santa Rosa',2),(3,'Boa Viagem',3),(4,'Rubem Berta',4),(5,'Jardim Morumbi',5);
